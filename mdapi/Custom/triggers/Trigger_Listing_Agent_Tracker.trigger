/**
  * Description     :   Trigger on Listing Agent License Tracker object and event is before insert and before update.
  * 
...
**/
trigger Trigger_Listing_Agent_Tracker on Listing_Agent_Tracker__c (before insert, before update) {
