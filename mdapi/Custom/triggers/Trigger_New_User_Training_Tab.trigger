/**
  * Description     :   Trigger on User Training Record object and event is before insert and before update.
  * 
...
**/
trigger Trigger_New_User_Training_Tab on New_User_Training_Tab__c (before insert, before update) {
