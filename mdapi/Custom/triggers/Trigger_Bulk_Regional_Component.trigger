/**
  * Description     :   Trigger on Bulk Regional Component object and event is before insert and before update.
  * 
...
**/
trigger Trigger_Bulk_Regional_Component on Bulk_Regional_Component__c (before insert, before update) {
